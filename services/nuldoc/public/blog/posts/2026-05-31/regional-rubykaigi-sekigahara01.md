...
さても、我がえすえぬえすの紋[^15]は元来 [ぴい五じえいえす](https://p5js.org/)[^16] にて作られしものにて[^17]、動くこそ本来の姿なれ。我が [あばうとぺえじ](https://about.nsfisis.dev/) にて動きたる版を見ること能ふ。
...
[^15]: SNS アイコン。
[^16]: p5.js。
[^17]: ただし現在は p5.js を使わずにバニラ JS で書き直されている。
[^18]: 玉入れ競争。言い換えではない。
[^19]: スポンサー。イベント公式訳。
